        ...
        <div class="row">
            <div class="col">
                <form action="{{route('add.order')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div><input type="text" value="{{$user->name}}" name="name" class="form-control" placeholder="eg: ram bahadur">
                            </div>
                            @error('name')
                ...
                <div class="col p-3 rounded" style="box-shadow: 1px 1px 10px black">
                    <h6 class="navbar-brand" style="font-size: 15px"><strong>Order Summary</strong></h6>
                    @php
                    $sum =0;
                    @endphp
